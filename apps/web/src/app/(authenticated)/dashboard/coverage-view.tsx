  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4.5 rounded-2xl bg-[#12161C] border border-[rgba(200,180,135,0.12)] hover:border-[rgba(200,180,135,0.24)] shadow-[0_4px_16px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#969DA6]">Monitored Nodes</span>
            <div className="p-1.5 rounded-lg bg-[#4D78A0]/15 border border-[#4D78A0]/30 text-[#BCA77B]">
              <Globe className="w-3.5 h-3.5" />
            </div>
          </div>
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl font-bold text-[#FAF9F5] font-mono">
              {monitoringData?.active_jurisdictions_count || 4}
            </span>
            <span className="text-xs text-[#969DA6] font-mono">
              / {monitoringData?.total_jurisdictions_count || 9} nodes
            </span>
          </div>
          <div className="mt-2 text-[10px] font-mono text-[#76937F] flex items-center gap-1.5 font-semibold">
        ...
        <div className="p-4.5 rounded-2xl bg-[#12161C] border border-[rgba(200,180,135,0.12)] hover:border-[rgba(200,180,135,0.24)] shadow-[0_4px_16px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#969DA6]">Active Rulesets</span>
            <div className="p-1.5 rounded-lg bg-[#76937F]/15 border border-[#76937F]/30 text-[#76937F]">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-[#969DA6] font-mono">enforced</span>
          </div>
          <div className="mt-2 text-[10px] font-mono text-[#969DA6] flex items-center gap-1">
        ...
        <div className="p-4.5 rounded-2xl bg-[#12161C] border border-[rgba(200,180,135,0.12)] hover:border-[rgba(200,180,135,0.24)] shadow-[0_4px_16px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#969DA6]">Surveillance Engine</span>
            <div className="p-1.5 rounded-lg bg-[#76937F]/15 border border-[#76937F]/30 text-[#76937F]">
              <Radio className="w-3.5 h-3.5" />
            </div>
          </div>
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl font-bold text-[#76937F] font-mono">ONLINE</span>
            <span className="text-xs text-[#969DA6] font-mono">24/7/365</span>
          </div>
          <div className="mt-2 text-[10px] font-mono text-[#969DA6]">
        ...
        <div className="p-4.5 rounded-2xl bg-[#12161C] border border-[rgba(200,180,135,0.12)] hover:border-[rgba(200,180,135,0.24)] shadow-[0_4px_16px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#969DA6]">Statutory Gazettes</span>
            <button
              onClick={handleManualSync}
              disabled={isSyncing}
              className="p-1.5 rounded-lg bg-[#171C23] border border-[rgba(200,180,135,0.12)] hover:border-[#BCA77B]/40 text-[#969DA6] hover:text-[#FAF9F5] transition-all cursor-pointer"
              title="Force sync live telemetry"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-[#BCA77B]' : ''}`} />
            </button>
          </div>
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-base font-bold text-[#FAF9F5] font-mono">Eur-Lex, SEC, FCA</span>
          </div>
          <div className="mt-2 text-[10px] font-mono text-[#969DA6] flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 w-full items-stretch">
        ...
        <div className="xl:col-span-7 w-full h-[620px] bg-[#12161C] rounded-2xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.8)] border border-[rgba(200,180,135,0.14)] relative group">
          {/* Tactical HUD Header for 3D Globe */}
          <div className="absolute top-3 left-4 z-20 pointer-events-none font-mono text-[9px] text-[#BCA77B] tracking-widest uppercase flex items-center gap-1.5">
        ...
        <div className="xl:col-span-5 w-full h-[620px] rounded-2xl overflow-hidden border border-[rgba(200,180,135,0.14)] bg-[#12161C] shadow-[0_24px_64px_rgba(0,0,0,0.8)]">
      ...
      <div className="p-6 rounded-2xl border border-[rgba(200,180,135,0.14)] bg-[#12161C] shadow-[0_24px_64px_rgba(0,0,0,0.8)]">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-5 pb-4 border-b border-[rgba(200,180,135,0.10)]">
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-[#FAF9F5] tracking-wide uppercase">
                Active Monitored Jurisdictions &amp; Enforced Standards
              </h3>
              <span className="px-2 py-0.5 rounded text-[11px] font-bold bg-[#BCA77B]/15 text-[#CDB98B] border border-[#BCA77B]/30 font-mono">
          ...
          <div className="flex items-center gap-2">
            {selectedJurisdiction && (
              <button
                ...
                className="text-xs px-2.5 py-1 rounded-md bg-[#171C23] hover:bg-[#1D232B] text-[#C7CCD2] border border-[rgba(200,180,135,0.12)] transition-colors cursor-pointer"
              >
            ...
            <button
              ...
              className="text-xs font-semibold px-3 py-1.5 rounded-lg rc-btn-sapphire-metal text-[#FAF9F5] transition-all flex items-center gap-1.5 shadow-[0_2px_8px_rgba(0,0,0,0.5)] border border-[#BCA77B]/25 cursor-pointer"
            >
              <span>Explore Regulations Catalog</span>
              <ArrowUpRight className="w-3.5 h-3.5 text-[#BCA77B]" />
            </button>
          </div>
        </div>
            ...
            return (
              <div
                ...
                className={`p-4.5 rounded-xl border transition-all cursor-pointer group relative ${
                  isSelected
                    ? 'bg-[#171C23] border-[#BCA77B] shadow-[0_4px_16px_rgba(0,0,0,0.6)]'
                    : (isLiveSignal
                        ? 'bg-[#171C23] border-[#BCA77B]/60 shadow-[0_4px_16px_rgba(0,0,0,0.6)]'
                        : 'bg-[#0C0F14] border-[rgba(200,180,135,0.10)] hover:border-[rgba(200,180,135,0.22)] hover:bg-[#171C23]/60')
                }`}
              >
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-[#FAF9F5] group-hover:text-[#CDB98B] transition-colors">
                        {jur.name}
                      </h4>
                  ...
                  <div className="flex items-center gap-1.5">
                    {isLiveSignal && (
                      <span className="text-[9px] font-mono font-bold py-0.5 px-2 rounded bg-[#BCA77B]/15 text-[#CDB98B] border border-[#BCA77B]/30 flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#BCA77B]" />
                        LIVE PING
                      </span>
                    )}
                    <span className={`text-[10px] font-mono font-semibold py-0.5 px-2 rounded border ${
                      jur.ruleset_count > 0
                        ? 'bg-[#76937F]/15 text-[#76937F] border-[#76937F]/30'
                        : 'bg-[#4D78A0]/15 text-[#C7CCD2] border-[#4D78A0]/30'
                    }`}>
                ...
                <div className="space-y-1.5 text-xs text-[#C7CCD2] my-3 font-mono">
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-[#969DA6]">Supervisory:</span>
                    <span className="text-[#FAF9F5] font-medium truncate max-w-[160px]" title={jur.authority}>
                      {jur.authority}
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-[#969DA6]">Compliance Health:</span>
                    <span className="text-[#76937F] font-bold">
                      {jur.compliance_score?.toFixed(1) || 94.0}%
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="text-[#969DA6]">Scope:</span>
                    <span className="text-[#C7CCD2] font-medium">{jur.ruleset_count || 0} Standards</span>
                  </div>
                </div>

                {jur.regulations && jur.regulations.length > 0 && (
                  <div className="pt-2 border-t border-[rgba(200,180,135,0.10)] flex flex-wrap gap-1 font-mono">
                    {jur.regulations.map((r: string, idx: number) => (
                      <span
                        key={`${jur.code || 'jur'}-${r}-${idx}`}
                        className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-[#12161C] text-[#C7CCD2] border border-[rgba(200,180,135,0.10)]"
                      >
                        {r}
                      </span>
                    ))}
                ...
                <div className="mt-3 pt-2 border-t border-[rgba(200,180,135,0.10)] flex items-center justify-between text-[11px] font-mono text-[#969DA6]">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      router.push(`/regulations?jurisdiction=${encodeURIComponent(jur.code)}`);
                    }}
                    className="text-[#BCA77B] hover:text-[#CDB98B] font-semibold flex items-center gap-1 transition-colors cursor-pointer"
                  >
                    Inspect Regulations <ArrowUpRight className="w-3 h-3" />
                  </button>
                  <span className="text-[#969DA6] group-hover:text-[#FAF9F5] flex items-center gap-0.5 transition-colors">
