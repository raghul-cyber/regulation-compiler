...
export function TransformationSection() {
  ...
  return (
    <section id="transformation" className="w-full max-w-6xl mx-auto px-4 md:px-6 pointer-events-auto scroll-mt-24">
      {/* Eyebrow & Title */}
        ...
        {STAGES.map((s, idx) => {
          ...
          return (
            <button
              ...
              className={`p-3 rounded-xl border text-left font-mono text-xs transition-all duration-200 cursor-pointer ${
                isActive
