...
export function FinalCTASection() {
  return (
    <section id="cta" className="w-full max-w-4xl mx-auto px-4 text-center pointer-events-auto pt-10">
      <div className="p-8 sm:p-14 rounded-2xl bg-[#080A0E] border border-[var(--rc-border)] shadow-2xl relative overflow-hidden">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#050608] border border-[var(--rc-border-subtle)] text-[#93C5FD] text-xs font-mono font-medium uppercase tracking-wider mb-5">
            <Terminal className="w-3.5 h-3.5 text-[#4D8FCC]" />
            Operational Readiness
          </div>

          <h2 className="text-3xl sm:text-5xl font-extrabold text-[#F4F6F8] tracking-tight mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Show when="signed-in">
              <Link href="/dashboard">
                <Button 
                  size="lg" 
                  className="bg-[#4D8FCC] hover:bg-[#3D7BBB] text-white rounded-lg font-medium px-8 h-11 transition-all cursor-pointer flex items-center gap-2 shadow-sm"
                >
              ...
              <Link href="/regulations">
                <Button 
                  size="lg" 
                  variant="secondary" 
                  className="rounded-lg font-medium px-8 h-11 bg-[#10141A] text-[#F4F6F8] border border-[var(--rc-border)] hover:border-[var(--rc-border-subtle)] hover:bg-[#10141A]/80 cursor-pointer"
                >
