...
export function WhatItDoesSection() {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[700px] h-[180px] sm:h-[360px] rounded-full blur-[90px] sm:blur-[140px] pointer-events-none -z-10 overflow-hidden"
        style={{
      ...
      <div 
        ref={cardsRef} 
        className={`landing-stagger ${cardsRevealed ? 'revealed' : ''} grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-6`}
      >
        {BENEFITS.map((b) => {
          const Icon = b.icon;
          ...
          return (
            <div
              ...
              className={`p-4 sm:p-6 md:p-7 rounded-xl rc-glass-smoked border transition-all duration-300 flex flex-col justify-between group relative overflow-hidden cursor-default shadow-[0_8px_24px_rgba(9,11,15,0.65)] ${
                isHovered
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-3.5 sm:mb-5">
                  <span className="font-mono text-[11px] sm:text-xs font-bold text-[#BCA77B] tracking-wider uppercase">
                    {b.action}
                  </span>
                  <span className="font-mono text-[11px] sm:text-xs text-[#969DA6]">
                    {b.step}
                  </span>
                </div>

                {/* Icon Box */}
                <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-[#12161C] border border-[rgba(199,204,210,0.12)] flex items-center justify-center text-[#BCA77B] mb-3.5 sm:mb-5 group-hover:scale-105 group-hover:border-[#BCA77B]/40 transition-all">
                  <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>

                {/* Title */}
                <h3 className="text-base sm:text-lg font-bold text-[#FAF9F5] mb-2 leading-snug group-hover:text-[#FAF9F5] transition-colors">
                  {b.title}
                </h3>
              ...
              {/* Bottom Outcome Tag */}
              <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-[rgba(199,204,210,0.08)] flex items-center gap-2 text-[11px] sm:text-xs font-mono text-[#76937F] relative z-10">
      ...
      <div className="mt-5 sm:mt-8 text-center">
        <button
          ...
          className="inline-flex items-center gap-2 text-xs font-mono font-medium text-[#BCA77B] hover:text-[#FAF9F5] transition-colors cursor-pointer group py-2"
        >
