...
files = {
    "src/components/settings/api-keys-list.tsx": """'use client';
    ...
    <>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 gap-4">
        ...
        <button 
          ...
          className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-[0_0_15px_rgba(37,99,235,0.4)] flex items-center gap-2 whitespace-nowrap"
        >
      ...
      {isModalOpen && !generatedRawKey && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0a0a0c] border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-zinc-900 text-sm text-zinc-200 p-3 rounded-lg border border-zinc-800 focus:outline-none focus:border-blue-500 transition-colors"
                />
              </div>
            ...
            <div className="p-5 border-t border-zinc-800 bg-zinc-950 flex justify-end space-x-3">
              ...
              <button 
                ...
                className="px-5 py-2 text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors disabled:opacity-50 flex items-center gap-2"
              >
      ...
      {generatedRawKey && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0a0a0c] border border-blue-500/30 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col">
...
""",
    ...
    "src/app/(authenticated)/settings/api-keys/page.tsx": """import { getApiKeys } from '@/lib/api';
...
""",
    ...
    "src/app/(authenticated)/settings/api-keys/loading.tsx": """import { Skeleton } from '@/components/ui/skeleton';
...
""",
    ...
    "src/app/(authenticated)/settings/api-keys/error.tsx": """'use client';
