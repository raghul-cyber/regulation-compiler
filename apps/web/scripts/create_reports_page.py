...
files = {
    "src/components/reports/reports-grid.tsx": """'use client';
      ...
      {initialReports.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {initialReports.map((report) => (
            <div key={report.id} className="bg-[#0a0a0c] border border-zinc-800 rounded-xl p-5 flex flex-col hover:border-zinc-700 transition-colors shadow-sm">
...
""",
    ...
    "src/app/(authenticated)/regulations/[id]/reports/page.tsx": """import { getReports } from '@/lib/api';
...
""",
    ...
    "src/app/(authenticated)/regulations/[id]/reports/loading.tsx": """import { Skeleton } from '@/components/ui/skeleton';
...
""",
    ...
    "src/app/(authenticated)/regulations/[id]/reports/error.tsx": """'use client';
  ...
  return (
    <div className="rounded-xl border border-red-900/50 bg-[#0a0a0c] p-12 text-center shadow-md">
      <div className="flex flex-col items-center justify-center space-y-4">
        <h3 className="text-xl font-semibold text-zinc-100">Failed to load Reports Library</h3>
