...
files = {
    "src/components/compliance/tester.tsx": """'use client';
      ...
      <div className="space-y-4">
        <div className="bg-[#0a0a0c] border border-zinc-800 rounded-xl overflow-hidden shadow-lg focus-within:border-blue-500/50 transition-colors">
          ...
          <textarea 
            ...
            className="w-full h-[400px] bg-transparent p-4 text-sm font-mono text-zinc-300 focus:outline-none resize-none"
            spellCheck="false"
          />
        </div>
        ...
        <button 
          ...
          className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-800 disabled:text-zinc-500 text-white font-semibold py-3 rounded-lg transition-all shadow-[0_0_15px_rgba(37,99,235,0.2)] flex justify-center items-center gap-2"
        >
          {isLoading ? (
...
""",
    ...
    "src/app/(authenticated)/compliance-check/page.tsx": """import { getRegulations } from '@/lib/api';
