...
with open("apps/web-next/src/components/3d/hero-scene.tsx", "w", encoding="utf-8") as f:
    f.write(hero_scene)
    
with open("apps/web-next/src/components/dashboard/dashboard-canvas.tsx", "w", encoding="utf-8") as f:
    f.write(dashboard_canvas)

print("Updated 3d components")
